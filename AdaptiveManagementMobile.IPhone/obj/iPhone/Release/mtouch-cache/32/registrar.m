...
@implementation LoginViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", "get_BtnLogin");
	}

	-(void) setBtnLogin:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", "set_BtnLogin");
	}

	-(id) TxtPassword
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", "get_TxtPassword");
	}

	-(void) setTxtPassword:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", "set_TxtPassword");
	}

	-(id) TxtUsername
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", "get_TxtUsername");
	}

	-(void) setTxtUsername:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", "set_TxtUsername");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", "DidReceiveMemoryWarning");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", "ViewDidLoad");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", ".ctor");
	}
@end
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", "set_Window");
	}

	-(BOOL) application:(id)p0 didFinishLaunchingWithOptions:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", "OnActivated");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", ".ctor");
	}
@end
...
@implementation FirstViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.FirstViewController, AdaptiveManagementMobileIPhone", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.FirstViewController, AdaptiveManagementMobileIPhone", "DidReceiveMemoryWarning");
	}
...
@implementation SecondViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.SecondViewController, AdaptiveManagementMobileIPhone", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "AdaptiveManagementMobile.IPhone.SecondViewController, AdaptiveManagementMobileIPhone", "DidReceiveMemoryWarning");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"LoginViewController", "AdaptiveManagementMobile.IPhone.LoginViewController, AdaptiveManagementMobileIPhone", NULL },
		{"AppDelegate", "AdaptiveManagementMobile.IPhone.AppDelegate, AdaptiveManagementMobileIPhone", NULL },
		{"FirstViewController", "AdaptiveManagementMobile.IPhone.FirstViewController, AdaptiveManagementMobileIPhone", NULL },
		{"SecondViewController", "AdaptiveManagementMobile.IPhone.SecondViewController, AdaptiveManagementMobileIPhone", NULL },
		{"__NSObject_Disposer", "Foundation.NSObject+NSObject_Disposer, Xamarin.iOS", NULL },
		{ NULL, NULL, NULL },
	};

	static const char *__xamarin_registration_assemblies []= {
		"AdaptiveManagementMobileIPhone", 
		"Xamarin.iOS", 
		"mscorlib"
	};
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [16].handle = objc_getClass ("UITextField");
	...
	__xamarin_class_map [22].handle = objc_getClass ("UIApplicationShortcutItem");
	...
	__xamarin_class_map [37].handle = [LoginViewController class];
	__xamarin_class_map [38].handle = [AppDelegate class];
	__xamarin_class_map [39].handle = [FirstViewController class];
	__xamarin_class_map [40].handle = [SecondViewController class];
